...
//  LOG(INFO) << "bottom[0]->num(): " << bottom[0]->num();
  LOG(INFO) << "bottom[1]->count(1): " << bottom[1]->count(1);
  for (int i = 0; i < bottom[0]->num(); ++i) {
    ...
    for (int j = 0; j < locations; ++j) {
      ...
      //LOG(INFO) << "true_index: " << true_index;
      //LOG(INFO) << "locations: " << locations;
      //LOG(INFO) << "j: " << j;
      LOG(INFO) << "The isobj Location: " << true_index + locations + j; //TODO
      ...
      LOG(INFO) << "true_box[0]" << true_box[0] << "best_box[0]" << best_box[0];
      LOG(INFO) << "true_box[1]" << true_box[1] << "best_box[1]" << best_box[1];
      LOG(INFO) << "true_box[2]" << true_box[2] << "best_box[2]" << best_box[2];
      LOG(INFO) << "true_box[3]" << true_box[3] << "best_box[3]" << best_box[3];
